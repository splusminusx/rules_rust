...
rust_library(
    ...
    crate_type = "lib",
    deps = [
        "@tonic_deps__getrandom__0_1_14//:getrandom",
        "@tonic_deps__libc__0_2_76//:libc",
        "@tonic_deps__rand_chacha__0_2_2//:rand_chacha",
        "@tonic_deps__rand_core__0_5_1//:rand_core",
        "@tonic_deps__rand_pcg__0_2_1//:rand_pcg",
    ],
    srcs = glob(["**/*.rs"]),
    ...
    aliases = {
        "@tonic_deps__getrandom__0_1_14//:getrandom": "getrandom_package",
    },
)
